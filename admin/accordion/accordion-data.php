...
$page_items = $_POST['page_items'];
/*---Including init.php File---*/
include "../init2.php";
/*---Select Data From Table And View It---*/
$select = sql("SELECT * FROM $table ORDER By id DESC LIMIT $page_start,$page_items","fetchAll");
?>
<table class="table">
<thead>
<tr>
        ...
        <!--Edit And Update Data-->
          <td class="popup" data-popup="popup-<?php echo $selectview['id'] ?>">
            <div class="popup-inner">
              ...
              <!--Update BTN-->
              <button type="submit" class="start-btn blue data-update"><?php echo lang('UPDATEBTN') ?></button>
              </form>
              <!--Close BTN-->
