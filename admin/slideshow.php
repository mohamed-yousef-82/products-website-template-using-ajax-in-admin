...
//Pending Users
if($do =='manage'){
echo "<h3 class='table-title'><span>Slideshow</span><i class='fa fa-building' aria-hidden='true'></i></h3>";
  // $sort = 'ASC';
...
elseif($do == 'add'){
?>
    <h3 class="table-title"><span>Add New Slide</span><i class="fa fa-users" aria-hidden="true"></i></h3>
...
elseif($do == 'edit'){
  ...
  ?>
  <h3 class="table-title"><span>Edit Slideshow</span><i class="fa fa-users" aria-hidden="true"></i></h3>
  <div class="child-page">
